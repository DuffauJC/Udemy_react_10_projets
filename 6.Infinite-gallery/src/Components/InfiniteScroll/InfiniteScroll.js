...
export default function InfiniteScroll() {
    ...
    const infiniteFetchData = () => {
        ...
        fetch(`https://api.unsplash.com/search/photos?page=${pageIndex}&per_page=30&query=${searchState}&client_id=O_mVDn76_jSF2LDI6UCWvaFco6msGB9godD6Q4p_oyg`).then((response) => {
